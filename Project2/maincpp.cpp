...
void Excersize_2_16(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("평균속도: %6.2lfm/(%6.2lfmin * %6.2lfs)= %6.2lfm/s\n\n", distance1, minute, second, medium_speed1);
		printf("구간2\n");
		printf("관련공식: s = v0t + 1/2at^2\n");
		printf("v:나중속도, v0t:처음 속도, a:가속도, t:시간\n");
		printf("%6.2lfm/st +%6.2lfm/st^2 \n\n", average_speed, rate_of_change / 2);
		printf("관련공식: v = (v0 + at)*(180-t)\n");
		printf("v:나중속도, v0:처음속도, a:가속도, t:시간, (180-t):가속하지 않는 시간 \n");
		printf("등속도: %6.2lf + %6.2lft -%6.2lft^2\n\n", average_time, (rate_of_change * time2) - average_speed, rate_of_change);
