...
void Excersize_2_16(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("구간1 평균속도는  %5.1lfm/(%5.1lfmin * %5.1lfs)= %.2lfm/s 입니다\n", distance1, minute, second, medium_speed1);
		printf("구간2 평균속도는 가속하는 시간 가속하지 않는 시간으로 둘 수 있습니다.\n");
		printf("가속하는 시간을 t로 둘 수 있고 가속하지 않는 구간을 %5.1f-t로 둘 수 있습니다.\n", time2);
		printf("등가속도 구하는 공식은 v=v0t + 1/2at^2입니다.\n");
		printf("구간2의 등가속도는 %5.2lfm/s +%5.2lfm/s^2 입니다\n", average_speed, rate_of_change / 2);
		printf("등속도의 공식은 v = v0 + at입니다.\n");
		printf("구간2의 등속도는 %5.1lf + %5.2lft -%5.2lft^2 입니다\n", average_time, (rate_of_change * time2)- average_speed, rate_of_change);
		printf("구간2의 등속도 + 등가속도 =%5.2lfm라는 식이 나옵니다.\n",distance2);
		printf("구간2의 식은 %5.2lft^2 + % 5.2lft % 5.2lf = %5.2lfm가 나옵니다.\n", a, b, c, d);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
