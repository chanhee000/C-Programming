...
void Excersize_2_16(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		printf("\n\n\n");
		printf("===============================풀이================================\n");
		printf("처음거리 %5.1lfm를 구간1과 구간2로 나눈다.구간1을 %5.1lfm로 두고 구간2를 %5.1lfm로 둔다\n", distance, distance1, distance2);
		...
		printf("구간2의 속도는 %5.2lfm/s^2 +%5.1lfm/s^2 입니다\n", average_speed, rate_of_change / 2);
		printf("구간2의 가속도%5.1lfm/s * %5.1lfs^2 = %5.1lfm입니다\n", rate_of_change, second, acceleration);
		printf("구간2의 이동거리는%5.1lf+(%5.2lf-%5.2lf)t -%5.2lft^2입니다\n", average_time, rate_of_change * 180, average_speed, rate_of_change);
		printf("구간2를 서로 합쳐계산하면 %5.2lft^2 +%5.2lft %5.2lf=%5.2lfm가 된다.\n", a, b, c, d);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
