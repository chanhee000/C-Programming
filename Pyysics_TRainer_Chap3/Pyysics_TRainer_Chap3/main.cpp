...
/*void Excersize_3_3(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("x의 부호는 -이고 변위의 길이는 %lf입니다\n ",height);
		printf("y의 부호는 -이고 변위의 길이는 %lf입니다\n ",height);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
...
{	
	...
	printf("\n\n");
	printf("3-15 \n");
	printf("높이%.000lfm인 곳에서 수평방향으로 던진 물체가 던진 곳에서 수평방항으로 %.0lfm인곳에 떨어졌다.",z,height);
	...
	if (solution == SHOW)
	{
		...
		printf("y=0,Vogt=0이고 g는%.00lf입니다.식에 숫자를 대입할 경우\n",g);
	...
	if (solution == SHOW)
	{
		...
		printf("===============================풀이================================\n");
		printf("(b)문제 \n");
		printf("물체의 초속도를 구하는 문제로 초기 높이는 Voxt입니다.초기높이는 %.000lfm입니다. \n",z);
